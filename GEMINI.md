...
### Layer 3: Schema (`GEMINI.md` + config)
...
├── ftp_probe_results.json         # Intermediate: FTP_probe results (gitignored)
│
├── GEMINI.md                      # Layer 3: Schema and project instructions
...
- **Phase 1 uses Gemini CLI interactively** for classification; Phase 2 will move to Anthropic API calls for automated batch processing
